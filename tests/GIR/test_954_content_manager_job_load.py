...
class TestContentManagerJobLoad(unittest.TestCase):
  mgd = None
  bookstore_one = None
  bookstore_one_copy = None
  bookstore_two = None
  bookstore_two_copy = None
  ...
  def testGetContentObject(self):
    self.assertEqual(self.job_one.get_content_object(), self.bookstore_one_copy)    
    self.assertEqual(self.job_two.get_content_object(), self.bookstore_two_copy)    
  ...
  def testZExecute(self):
    ...
    self.assertNotEqual(self.bookstore_one_copy.get_property("guid"), None)
    self.assertEqual(self.bookstore_one_copy.get_property("guid"), self.bookstore_one.get_property("guid"))
    ...
    self.assertNotEqual(self.callback_msg_end, None)
    self.assertEqual(self.callback_msg_end, "DONE END")
    self.assertNotEqual(self.bookstore_two_copy.get_property("guid"), None)
    self.assertEqual(self.bookstore_two_copy.get_property("guid"), self.bookstore_two.get_property("guid"))
