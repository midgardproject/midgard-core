...
void midgard_cr_core_sql_storage_content_manager_storable_purge (MidgardCRStorable *storable, MidgardCRSQLStorageManager *manager,  MidgardCRObjectModel *object_model, MidgardCRSQLTableModel *table_model, GError **error);
