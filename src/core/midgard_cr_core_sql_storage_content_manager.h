...
void midgard_cr_core_sql_storage_content_manager_storable_insert (MidgardCRRepositoryObject *storable, MidgardCRSQLStorageManager *manager,  MidgardCRObjectModel *object_model, MidgardCRSQLTableModel *table_model, GError **error);
void midgard_cr_core_sql_storage_content_manager_storable_update (MidgardCRRepositoryObject *storable, MidgardCRSQLStorageManager *manager,  MidgardCRObjectModel *object_model, MidgardCRSQLTableModel *table_model, GError **error);
void midgard_cr_core_sql_storage_content_manager_storable_purge (MidgardCRRepositoryObject *storable, MidgardCRSQLStorageManager *manager,  MidgardCRObjectModel *object_model, MidgardCRSQLTableModel *table_model, GError **error);
