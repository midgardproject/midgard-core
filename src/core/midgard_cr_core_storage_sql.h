...
#define TABLE_MAPPER_PROPERTIES_COLUMNS "property_name, column_name, table_name, gtype_name, column_type, is_primary, has_index, is_unique, is_auto_increment, description, is_reference, reference_holder, reference_table_name, reference_column_name, property_of"
...
#define TABLE_SCHEMA_PROPERTIES_COLUMNS "class_name, property_name, gtype_name, default_value_string, property_nick, description, is_reference, reference_holder, reference_class_name, reference_property_name, namespace"
