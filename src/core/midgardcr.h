/* midgardcr.h generated by valac 0.11.3, the Vala compiler, do not modify */
...
struct _MidgardCRObjectManagerClass {
	...
	MidgardCRStorable* (*factory) (MidgardCRObjectManager* self, const gchar* classname, const gchar* guid, GError** error);
...
MidgardCRStorable* midgard_cr_object_manager_factory (MidgardCRObjectManager* self, const gchar* classname, const gchar* guid, GError** error);
