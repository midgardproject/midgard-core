...
struct _MidgardCRStorageModelPropertyIface {
	GTypeInterface parent_iface;
	const char* (*get_location) (MidgardCRStorageModelProperty* self);
	void (*set_location) (MidgardCRStorageModelProperty* self, const char* value);
...
const char* midgard_cr_storage_model_property_get_location (MidgardCRStorageModelProperty* self);
void midgard_cr_storage_model_property_set_location (MidgardCRStorageModelProperty* self, const char* value);
